...
Y_UNIT_TEST(PgConvertNumericDouble) {
    ...
    NYql::NUdf::TStringBlockReader<arrow20::BinaryType, true> reader;
...
Y_UNIT_TEST(PgConvertNumericDecimal128Scale1) {
    ...
    int32_t precision = 6;
    int32_t scale = 1;
    std::shared_ptr<arrow20::DataType> type(new arrow20::Decimal128Type(precision, scale));
    arrow20::Decimal128Builder builder(type);

    const char* expected[] = {
        "12345.0", "-12345.0", nullptr
    };

    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("12345.0").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-12345.0").ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertNumericDecimal128ScaleNegative) {
    ...
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("12345678").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-12345678").ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertNumericDecimal128Scale2) {
    ...
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("123.45").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-123.45").ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertNumericDecimal128Scale3) {
    ...
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("0.123").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-0.123").ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertNumericDecimal128Scale4) {
    ...
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("123.4567").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-123.4567").ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertNumericDecimal128Scale5) {
    ...
    ARROW_OK(builder.Append(arrow20::Decimal128::FromReal(12.34567, precision, scale).ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromReal(-12.34567, precision, scale).ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertNumericDecimal128BigScale3) {
    ...
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("36893488147419103.245").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-36893488147419103.245").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("46116860184273879.041").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-46116860184273879.041").ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertNumericDecimal128BigScale1) {
    ...
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("3868562622766813359059763.2").ValueOrDie()));
    ARROW_OK(builder.Append(arrow20::Decimal128::FromString("-3868562622766813359059763.2").ValueOrDie()));
    ARROW_OK(builder.AppendNull());
...
Y_UNIT_TEST(PgConvertDate32Date) {
    ...
    auto converter = BuildPgColumnConverter(std::shared_ptr<arrow20::DataType>(new arrow20::Date32Type), targetType);
