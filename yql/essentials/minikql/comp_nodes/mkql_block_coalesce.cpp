...
arrow20::Status BlockCoalesceKernelExec(arrow20::compute::KernelContext* ctx, const arrow20::compute::ExecSpan& batch, arrow20::compute::ExecResult* res) {
    auto* exec = reinterpret_cast<TCoalesceBlockExec*>(ctx->kernel()->data.get());
