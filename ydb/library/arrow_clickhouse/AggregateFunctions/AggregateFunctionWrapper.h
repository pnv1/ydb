...
public:
    ArrowAggregateFunctionWrapper(std::string name)
        : arrow20::compute::ScalarAggregateFunction(std::move(name), arrow20::compute::Arity::Unary(), arrow20::compute::FunctionDoc{})
    {}
...
public:
    ArrowGroupBy(std::string name)
        : arrow20::compute::ScalarAggregateFunction(std::move(name), arrow20::compute::Arity::VarArgs(1), arrow20::compute::FunctionDoc{})
    {}
