...
TConclusion<bool> TStreamLogicProcessor::OnInputReady(
    ...
    if (auto accInput = context.GetResources().GetAccessorOptional(inputId)) {
...
public:
    ...
    TSpecFunctionsOperator() {
        ...
        for (auto&& i : Kernels) {
            ...
            auto func = std::make_shared<arrow20::compute::ScalarFunction>("local_function", arity, arrow20::compute::FunctionDoc{});
