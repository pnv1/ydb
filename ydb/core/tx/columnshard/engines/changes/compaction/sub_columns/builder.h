...
private:
    using TSparsedBuilder = NArrow::NAccessor::TSparsedArray::TSparsedBuilder<arrow20::StringType>;
    using TPlainBuilder = NArrow::NAccessor::TTrivialArray::TPlainBuilder<arrow20::StringType>;
