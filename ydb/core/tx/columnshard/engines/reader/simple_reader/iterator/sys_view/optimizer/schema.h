...
private:
    ...
    static const inline auto Registrator1 = TFactory::TRegistrator<TSchemaAdapter>("store_primary_index_optimizer_stats");
    static const inline auto Registrator2 = TFactory::TRegistrator<TSchemaAdapter>("primary_index_optimizer_stats");
