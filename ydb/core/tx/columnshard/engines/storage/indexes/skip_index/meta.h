...
private:
    ...
    virtual bool DoCheckValue(const TString& data, const std::optional<ui64> cat, const std::shared_ptr<arrow20::Scalar>& value,
        const NArrow::NSSA::TIndexCheckOperation& op) const = 0;

public:
    bool CheckValue(const TString& data, const std::optional<ui64> cat, const std::shared_ptr<arrow20::Scalar>& value,
...
private:
    ...
    virtual bool DoCheckValueImpl(const IBitsStorage& data, const std::optional<ui64> cat, const std::shared_ptr<arrow20::Scalar>& value,
        const NArrow::NSSA::TIndexCheckOperation& op) const = 0;
